...
var TableFixed = function(table, options){
	this._oTable = document.getElementById(table);//原table
	this._nTable = this._oTable.cloneNode(false);//新table
	this._nTable.id = "TbData2";//避免id冲突
